...
Generated (UTC): 2026-09-24T01:22:13Z by `M1/src/validate.py`.

**Overall: PASS** - 0 failure(s) across 19 rule groups.

| rule | check | rows checked | result |
|---|---|---|---|
| V1 | provenance references resolve | 1266 | PASS |
| V2 | numeric facts carry sources or are declared UNKNOWN | 536 | PASS |
| V3 | gate ceiling and dead/ALIVE integrity | 36 | PASS |
| V4 | referential integrity | 910 | PASS |
| V5 | no scoring or ranking artifacts | 539 | PASS |
| V6 | stable ids unique | 440 | PASS |
| V7 | time-sensitive sources dated | 105 | PASS |
