...
|---|---|---|---|
| V1 | provenance references resolve | 1297 | PASS |
| V2 | numeric facts carry sources or are declared UNKNOWN | 547 | PASS |
| V3 | gate ceiling and dead/ALIVE integrity | 39 | PASS |
| V4 | referential integrity | 950 | PASS |
| V5 | no scoring or ranking artifacts | 539 | PASS |
| V6 | stable ids unique | 450 | PASS |
